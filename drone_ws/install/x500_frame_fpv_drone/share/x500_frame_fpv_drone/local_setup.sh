...
: ${AMENT_CURRENT_PREFIX:="/home/shiv/drone_ws/install/x500_frame_fpv_drone"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/x500_frame_fpv_drone/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/x500_frame_fpv_drone/environment/path.sh"
